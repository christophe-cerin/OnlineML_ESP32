...
<img alt="Console bash" src="https://github.com/madou-sow/OnlineML_ESP32/blob/main/ARDUINO/Data-processing-with-Arduino-IDE-and-IOT/images/generdata.png" width=70% height=70%  title="Console bash"/>

###### **Figure 1 : In a terminal you have to run the program to generate**

<img alt="Arduino IDE serial monitor" src="https://github.com/madou-sow/OnlineML_ESP32/blob/main/ARDUINO/Data-processing-with-Arduino-IDE-and-IOT/images/arduinoreceivmessag.png" width=60% height=60%  title="Arduino IDE serial monitor"/>
